...
- `smoothness` values:
    ...
    | `very_bad` | High-clearance vehicles, light off-road vehicles | Unpaved roads with potholes and ruts, passable with SUV ground clearance (&ge;18 cm) | Rough terrain |
    | `horrible` | Heavy off-road vehicles, dual-sport motorcycles | Unpaved tracks with deep ruts and rocks needing ground clearance &ge;21 cm | Skid plate protection advisable |
    | `very_horrible` | Specialized off-road vehicles, tractors, ATVs | Tracks with deep ruts and obstacles needing ground clearance &ge;24 cm | Includes mountain bikes and trial/enduro motorcycles |
...
- how smoothness looks like on OSM
    ...
    ![image.png](/materials/Attributes_on_OpenStreetMaps/image.png)
    
    ![image.png](/materials/Attributes_on_OpenStreetMaps/image_1.png)
...
- how `wheelchair` looks like on OSM
    ...
    ![image.png](/materials/Attributes_on_OpenStreetMaps/image_2.png)
    
    ![image.png](/materials/Attributes_on_OpenStreetMaps/image_3.png)
...
- how ramp looks like on OSM
    ...
    ![image.png](/materials/Attributes_on_OpenStreetMaps/image_4.png)
    
    ![image.png](/materials/Attributes_on_OpenStreetMaps/image_5.png)
    
    ![image.png](/materials/Attributes_on_OpenStreetMaps/image_6.png)
    
    ![image.png](/materials/Attributes_on_OpenStreetMaps/image_7.png)
...
- how surface looks like on OSM
    ...
    ![image.png](/materials/Attributes_on_OpenStreetMaps/image_8.png)
    
    ![image.png](/materials/Attributes_on_OpenStreetMaps/image_9.png)
...
- how `barrier` looks like on OSM
    ...
    ![image.png](/materials/Attributes_on_OpenStreetMaps/image_10.png)
    
    ![image.png](/materials/Attributes_on_OpenStreetMaps/image_11.png)
...
- often derived from road signs:
    ...
    ![image.png](/materials/Attributes_on_OpenStreetMaps/image_12.png)
...
- how incline looks like on OSM
    ...
    ![image.png](/materials/Attributes_on_OpenStreetMaps/image_13.png)
    
    ![image.png](/materials/Attributes_on_OpenStreetMaps/image_14.png)
...
- how `access` looks like on OSM
    ...
    ![image.png](/materials/Attributes_on_OpenStreetMaps/image_15.png)
    
    ![image.png](/materials/Attributes_on_OpenStreetMaps/image_16.png)
...
- how `foot` looks like on OSM
    ...
    ![image.png](/materials/Attributes_on_OpenStreetMaps/image_17.png)
    
    ![image.png](/materials/Attributes_on_OpenStreetMaps/image_18.png)